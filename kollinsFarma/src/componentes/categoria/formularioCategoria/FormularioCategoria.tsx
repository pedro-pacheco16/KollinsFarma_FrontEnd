    ...
    async function gerarNovaCategoria(e: ChangeEvent<HTMLFormElement>) {
        ...
        if (id !== undefined) {
            try {
                ...
                alert('Categorias atualizado com sucesso')
            } catch (error: any) {
                    alert('Erro ao atualizar as Categorias')
                }
            } else {
            try {
    ...
    return (
        <div className="container flex flex-col items-center justify-center mx-auto">
            ...
            <form className="w-1/2 flex flex-col gap-4" onSubmit={gerarNovaCategoria}>
                ...
                <button
                    className="rounded text-slate-100 bg-secondary 
                    hover:bg-primary w-1/2 py-2 mx-auto flex justify-center" type="submit">
